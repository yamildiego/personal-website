...
export default class Slider extends React.Component {
    ...
    static getDerivedStateFromProps = (props, state) => {
        if (props.position !== state.position) {
            const noAnimate = props.position === Slider.CENTER;
            const animatingOut = [Slider.TO_LEFT, Slider.TO_RIGHT].includes(props.position);
            const currentlyIn = [
                Slider.CENTER,
                Slider.FROM_LEFT,
                Slider.FROM_RIGHT
            ...
            if (noAnimate || (currentlyIn && animatingOut)) {
                ...
                this._animationCallback = props.animationCallback;
                return {
                    ...this.state,
                    animatePrepare: false,
